...
write.table(export.dge.cpm, file = 'EdgeR T30 Normalized Counts.tsv', sep = '\t', row.names = FALSE, col.names = TRUE)
...
write.table(export.final.top, file = 'EdgeR T30 Top Hits.tsv', sep = '\t', row.names = FALSE, col.names = TRUE)